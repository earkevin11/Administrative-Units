...
# Use Case: 
- Two Administrative Units with two users and two groups of one user managed by Admin A with the user administrator role
- Two other users in the Default Directory manged by Admin B
